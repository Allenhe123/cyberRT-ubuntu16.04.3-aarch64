...
void InitDefaultsNeedataImpl();
void InitDefaultsNeedata();
...
class Needata : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.cyber.proto.Needata) */ {
 public:
  ...
  inline Needata* New() const PROTOBUF_FINAL { return New(NULL); }

  Needata* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_unit_5ftest_2eproto::TableStruct;
  friend void ::protobuf_unit_5ftest_2eproto::InitDefaultsNeedataImpl();
};
// ===================================================================
...
inline ::std::string* Needata::release_data3() {
  ...
  clear_has_data3();
  return data3_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* Needata::release_data4() {
  ...
  clear_has_data4();
  return data4_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* Needata::release_data5() {
  ...
  clear_has_data5();
  return data5_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* Needata::release_data6() {
  ...
  clear_has_data6();
  return data6_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* Needata::release_data7() {
  ...
  clear_has_data7();
  return data7_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* Needata::release_data8() {
  ...
  clear_has_data8();
  return data8_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* Needata::release_data9() {
  ...
  clear_has_data9();
  return data9_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
