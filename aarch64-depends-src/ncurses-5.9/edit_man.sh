...
TERMINFO="/ncurses-5.9/share/terminfo"
...
*.[0-9]*)
	...
	if test ! -f /home/allen/ncurses-5.9/man_alias.sed ; then
cat >>/home/allen/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/allen/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/allen/ncurses-5.9/man_alias.sed | sort -u`
	cf_target=`grep "^$cf_source" /home/allen/ncurses-5.9/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/allen/ncurses-5.9/man_alias.sed \
		< $i | sed -f /home/allen/ncurses-5.9/edit_man.sed >$TMP
